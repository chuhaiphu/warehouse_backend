...
public class WarehouseApplication {
	...
	CommandLineRunner initData(
		...
		return args -> {
			...
			Account acc2 = new Account(null, "wk.john@example.com", "12345", "987654321", "John Smith", AccountStatus.ACTIVE, true, false, AccountRole.STAFF, null, null, null, null, null);
			...
			Account acc5 = new Account(null, "wk.sarah@example.com", "12345", "555111222", "Sarah Johnson", AccountStatus.ACTIVE, true, false, AccountRole.STAFF, null, null, null, null, null);
			Account acc6 = new Account(null, "wk.michael@example.com", "12345", "555222333", "Michael Chen", AccountStatus.ACTIVE, true, false, AccountRole.STAFF, null, null, null, null, null);
			Account acc7 = new Account(null, "wk.emily@example.com", "12345", "555333444", "Emily Rodriguez", AccountStatus.ACTIVE, true, false, AccountRole.STAFF, null, null, null, null, null);
			Account acc8 = new Account(null, "wk.david@example.com", "12345", "555444555", "David Wilson", AccountStatus.ACTIVE, true, false, AccountRole.STAFF, null, null, null, null, null);
			Account acc9 = new Account(null, "wk.lisa@example.com", "12345", "555555666", "Lisa Thompson", AccountStatus.ACTIVE, true, false, AccountRole.STAFF, null, null, null, null, null);
